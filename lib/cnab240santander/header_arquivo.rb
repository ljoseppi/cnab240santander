module Cnab240santander
  class HeaderArquivo < Cnab240santander::Base
    def self.processar(linha)
      vlinha = Hash.new
      vlinha["banco"]                  = linha[0..2] #num //Codigo do Banco na Compensacao
      vlinha["lote"]                   = linha[3..6] #num - default 0000 //Lote de Servico
      vlinha["registro"]               = linha[7..7] #num - default 0 //Tipo de Registro
      vlinha["res_banco1"]             = linha[8..15] #alfa //Reservado (uso Banco) - Brancos
      vlinha["tipo_inscricao_empresa"] = linha[16..16] #num //Tipo de Inscricao da Empresa
      vlinha["num_inscricao_empresa"]  = linha[17..31] #num  //Numero de Inscricao da Empresa
      vlinha["agencia"]                = linha[32..35] #num  //Agencia do Cedente
      vlinha["dv_agencia"]             = linha[36..36] #num //Digito da Agencia do Cedente
      vlinha["conta_corrente"]         = linha[37..45] #num //Numero da conta corrente
      vlinha["dv_conta"]               = linha[46..46] #num //DV da Conta Corrent
      vlinha["res_banco2"]             = linha[47..51] #alfa  //Reservado (uso Banco) - Brancos
      vlinha["cod_cedente"]            = linha[52..60] #num //Codigo do Cedente
      ...
      vlinha["cod_retorno"]            = linha[142..142] #num - Codigo remessa / retorno
      vlinha["data_geracao_arq"]       = linha[143..150] #num - Data de geracao do arquivo - DDMMAAAA
      ...
      vlinha["versao"]                 = linha[163..165] #num //No da versao do layout do arquivo
